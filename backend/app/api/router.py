...
from backend.app.api.v1.exam_sessions import router as exam_sessions_router
...
from backend.app.api.v1.user_admin import router as user_admin_router
...
api_router.include_router(exam_sessions_router)
