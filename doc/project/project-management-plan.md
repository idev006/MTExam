...
## 27. Reporting UI/UX delivery baseline

The reporting layout, role matrix, responsive behavior, ECharts plan, export rules, sequence
diagram and acceptance criteria are maintained in [Reporting UI/UX Design](reporting-ui-ux-design.md).
The Project Manager must track REPORT-UX-01 through REPORT-QA-08 in the GitHub Project. A report
feature cannot move to Done without scope/permission tests, responsive device evidence, export
verification and updated API/UI documentation.
