...
- ผู้สร้างต้องระบุระยะเวลาทำข้อสอบเริ่มต้น (`default_duration_minutes`) เป็นจำนวนนาที 1–600;
  Exam Window ใช้ค่านี้เมื่อไม่ได้ระบุระยะเวลาเฉพาะรอบ
...
- สิทธิ์และ quota บน Exam Creation เป็น template; เมื่อสร้าง ExamWindow ระบบต้อง snapshot
  organization และ quota สำหรับรอบนั้นก่อนบังคับใช้จริง
...
- ผู้สร้างเท่านั้นที่เปลี่ยนสถานะ Exam Creation ของตนได้ และ backend ต้องตรวจสิทธิ์ทุกครั้ง
- การกลับจาก Published/Archived เป็น Draft ทำได้เฉพาะเมื่อยังไม่เคยมี Exam Window
- การ Archived ไม่ยกเลิก Exam Window หรือ session ที่เริ่มไปแล้ว
