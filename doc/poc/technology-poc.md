...
| POC-PORT-02 | Portable schema | compile ตารางทั้ง 23 ตารางด้วย SQLite, MySQL และ PostgreSQL dialect | Passed offline |
...
| POC-AUTH-02 | Stateless access token | HS256 JWT, required claims, issuer/audience, expiry, signature และ secret ≥ 32 bytes | Passed |
