    ...
    <div class="grid gap-6 lg:grid-cols-[20rem_1fr]">
      <section class="card border border-base-300 bg-base-100 shadow-sm"><div class="card-body">
        ...
        <form class="space-y-3" @submit.prevent="create">
          ...
          <select v-model="form.role" class="select select-bordered w-full"><option v-for="role in roleOptions" :key="role" :value="role">{{ role }}</option></select>
